...
const RICH_TEXT_STYLES: Record<string, string> = {
  ...
  li: `margin:0 0 6px;`,
  blockquote: `margin:0 0 16px;padding:4px 0 4px 16px;border-left:3px solid ${COLORS.brand};font-style:italic;color:${COLORS.muted};`,
  ...
  mark: `background-color:${COLORS.brandTint};padding:0 2px;`,
  span: '',
  br: '',
