...
const RICH_TEXT_STYLES: Record<string, string> = {
  ...
  pre: `margin:0 0 16px;padding:14px 16px;border-radius:8px;background-color:#1A1A18;color:#FAFAF7;font-family:ui-monospace,Menlo,Consolas,monospace;font-size:13px;line-height:1.6;overflow-x:auto;white-space:pre-wrap;`,
  ...
  a: `color:${COLORS.navy};text-decoration:underline;`,
