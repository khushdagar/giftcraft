      ...
      <body>
        <div className="min-h-screen bg-gray-50 py-12 px-4 flex items-center justify-center">
          <div className="max-w-md text-center">
            {/* Logo */}
            <h1 className="text-4xl font-black text-gray-900 mb-6">GiftCraft</h1>

            {/* Error Icon */}
            <div className="text-6xl mb-6">⚠️</div>

            {/* Error Message */}
            <p className="text-xl font-bold text-gray-900 mb-2">Critical Error</p>
            ...
            <div className="space-y-3">
              <button
                onClick={reset}
                className="w-full bg-blue-700 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-800 transition"
              >
                Try Again
              </button>
              <button
                onClick={() => window.location.href = '/'}
                className="w-full bg-gray-200 text-gray-900 px-6 py-3 rounded-xl font-bold hover:bg-gray-300 transition"
              >
                Go to Home
              </button>
            </div>
