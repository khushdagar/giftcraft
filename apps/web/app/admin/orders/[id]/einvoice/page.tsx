  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-normal tracking-tight text-ink">E-Invoice</h1>
      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="border border-bdr rounded-lg p-6 space-y-4">
            <h2 className="text-lg font-normal text-ink">Invoice Generated</h2>

            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
              <div className="space-y-3">
                <div>
                  <p className="text-xs text-emerald-600 uppercase font-normal">IRN (Invoice Registration Number)</p>
                  <p className="text-lg font-normal text-emerald-900 mt-1">{einvoice.irn}</p>
                </div>
                {einvoice.ackNumber && (
                  <div>
                    <p className="text-xs text-emerald-600 uppercase font-normal">Acknowledgement Number</p>
                    <p className="text-sm font-normal text-emerald-900 mt-1">{einvoice.ackNumber}</p>
                  </div>
                )}
                {einvoice.ackDate && (
                  <div>
                    <p className="text-xs text-emerald-600 uppercase font-normal">Acknowledged Date</p>
                    <p className="text-sm font-normal text-emerald-900 mt-1">
            ...
            {einvoice.qrPayload && (
              <div className="border border-bdr rounded-lg p-4 bg-elevated">
                <p className="text-xs text-ink-2 uppercase font-normal mb-3">QR Code Data</p>
            ...
            <div className="text-sm text-ink-2 pt-4 border-t border-bdr">
              <p>Status: <span className="font-normal text-ink">{einvoice.status}</span></p>
        ...
        <div className="border border-bdr rounded-lg p-12 text-center space-y-4">
          ...
          <Button
            ...
            className="rounded-2xl bg-em px-6 py-2 font-normal hover:bg-em-600"
          >
