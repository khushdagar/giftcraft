...
export default function DisputeFilingPage({ params, searchParams }: PageProps) {
  ...
  const uploadPhoto = async (photo: File): Promise<string> => {
    ...
    // In production, upload to Digital Ocean Spaces
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full rounded-lg bg-white shadow-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-black text-ink mb-2">Dispute Filed</h1>
          <p className="text-sm text-ink-2 mb-4">
          ...
          <div className="bg-emerald-50 rounded-md p-4 mb-6">
            <p className="text-xs text-emerald-700 font-semibold mb-1">REFERENCE NUMBER</p>
            <p className="text-xl font-black text-emerald-700">{referenceNumber}</p>
          ...
          <div className="flex gap-3">
            <a
              href="/"
              className="flex-1 px-4 py-2 rounded-md border-2 border-bdr hover:bg-gray-50 font-semibold text-sm transition"
            >
              Home
            </a>
            <a
              href="/dashboard/orders"
              className="flex-1 px-4 py-2 rounded-md bg-emerald-600 text-white hover:bg-emerald-700 font-semibold text-sm transition"
            >
              View Orders
            </a>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-black text-ink mb-2">File a Dispute</h1>
        ...
        <div className="mt-8 text-center text-sm text-ink-3">
          <p>
            ...
            <a href="mailto:support@giftcraft.in" className="text-em font-semibold hover:underline">
