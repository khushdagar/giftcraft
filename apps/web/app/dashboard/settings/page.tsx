  ...
  return (
    <div>
      <div className="mb-8 border-b border-bdr pb-8">
        <h1 className="text-3xl font-normal tracking-tight text-ink">Settings</h1>
        ...
        {settingsSections.map((section) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="font-normal text-ink mb-2">{section.title}</h3>
              <p className="text-sm text-ink-2">{section.description}</p>
              <div className="mt-4 text-xs font-normal text-em group-hover:underline">
                Go to {section.title} →
              </div>
            </Link>
          );
