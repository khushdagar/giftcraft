  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8 border-b border-bdr pb-8">
        <h1 className="text-3xl font-normal tracking-tight text-ink">File a Dispute</h1>
        <p className="mt-2 text-sm text-ink-2">You have 48 hours from delivery to file a dispute</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label className="block text-sm font-normal text-ink mb-2">Order *</label>
          <select
        ...
        <div>
          <label className="block text-sm font-normal text-ink mb-2">Subject *</label>
          <Input
            name="subject"
        ...
        <div>
          <label className="block text-sm font-normal text-ink mb-2">Describe the Issue *</label>
          <Textarea
            name="body"
            value={formData.body}
            onChange={handleChange}
        ...
        <div>
          <label className="block text-sm font-normal text-ink mb-2">Photos (1-3 required) *</label>
          <div className="border-2 border-dashed border-bdr rounded-lg p-6 text-center">
            ...
            <label htmlFor="photo-input" className="cursor-pointer">
              <p className="text-sm font-normal text-ink mb-1">Click to upload photos</p>
              ...
              {photoUrls.map((url, idx) => (
                <div key={idx} className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-1 right-1 bg-err text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-normal"
                  >
                    ×
                  </button>
                </div>
